...
class _GroupManagementScreenState extends State<GroupManagementScreen> {
  ...
  Future<void> _loadGroups() async {
    ...
    try {
      final data = await SupabaseService.instance.fetchPrimaryGroups(
        widget.weddingId,
      );
      setState(() {
        _groups = data;
  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      ...
      if (_editingGroup == null) {
        // Create new
        await SupabaseService.instance.createPrimaryGroup(
          widget.weddingId,
          name,
        );
      } else {
        // Edit name
        await SupabaseService.instance.updatePrimaryGroup(
          _editingGroup!.id,
          name,
        );
      }
              ...
              children: [
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            _editingGroup == null
                                ? 'Tạo Nhóm Quan hệ mới'
                                : 'Sửa Nhóm: ${_editingGroup!.name}',
                                ...
                                child: TextFormField(
                                  ...
                                  validator: (val) {
                                    ...
                                    if (val.trim().length > 100)
                                      return 'Tên nhóm tối đa 100 ký tự';
                                    return null;
                                  },
                                ),
                              ),
                ...
                Expanded(
                  child: _groups.isEmpty
                      ? const Center(
                          child: Text(
                            'Chưa có nhóm quan hệ nào được tạo.',
