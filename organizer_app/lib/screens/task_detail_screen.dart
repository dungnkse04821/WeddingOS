  ...
  Future<void> _handleSave() async {
    ...
    try {
      ...
      final Map<String, dynamic> updates = {
        ...
        'wedding_event_id':
            _deadlineIntent == 'USER_RELATIVE' ||
                _deadlineIntent == 'SYSTEM_RELATIVE'
            ? _eventId
            : null,
        'date_offset':
            _deadlineIntent == 'USER_RELATIVE' ||
            ...
            ? _dateOffset
            : null,
        'custom_override_date': _deadlineIntent == 'USER_ABSOLUTE'
            ? _customOverrideDate?.toIso8601String().split('T').first
            : null,
      };
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            if (_deadlineIntent == 'USER_RELATIVE' ||
                _deadlineIntent == 'SYSTEM_RELATIVE') ...[
              const Text(
                'Target Event Link',
                style: TextStyle(
              ...
              const Text(
                'Date Offset (Days relative to Event)',
                style: TextStyle(
                  color: Colors.white38,
                  fontSize: 12,
                  fontWeight: FontWeight.bold,
